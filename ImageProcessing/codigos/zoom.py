# -*- coding: utf-8 -*-
"""
Created on Tue Jan 31 13:49:40 2023
...
with mp_hands.Hands(
    ...
    while True:
        ...
        resize_cropped = cv2.flip(resized_cropped,1)
        
        copia=resize_cropped
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                radiusX,radiusY = int(scale*frame_height/100), int(scale*frame_width/100)
                
                endX,endY = int(centerX+radiusX), int(centerY+radiusY)
            ...
            cropped = resize_cropped[centerX:endX, centerY:endY]
            
            copia = cv2.resize(cropped, (frame_width, frame_height))
